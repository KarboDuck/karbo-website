...
export default {
  ...
  hero: {
    ...
    githubContribution: 'Содействовать(сотрудничать) на GitHub',
  ...
  about: {
    ...
    full_control: {
      ...
      content: 'Только вы контроллируете свои деньги в Karbo. Никто не может их изъять, ограничить к ним доступ, или лишить вас возможности свободно ими распоряжаться.',
    },
    no_intermediates: {
