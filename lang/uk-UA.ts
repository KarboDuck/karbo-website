...
export default {
  ...
  about: {
    label: 'Про Карбо',
    title: 'Переваги(Особливості) Карбо',
    ...
    full_control: {
      ...
      content: 'Ніхто не може їх вилучити, обмежити доступ до них, або позбавити можливості вільно розпоряджатися своїми власними грошима.',
    },
    no_intermediates: {
    ...
    openness: {
      ...
      content: 'Karbo це відкрита та децентралізована мережа, в якій кожен може взяти участь у майнінгу, розробці та управлінні.',
    },
    security: {
  ...
  download: {
    ...
    wallets: {
      ...
      classic: {
        ...
        description: 'Основний та рекомендований гаманець Karbo для ПК.',
      },
      spring: {
